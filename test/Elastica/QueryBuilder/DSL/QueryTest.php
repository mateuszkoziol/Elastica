...
class QueryTest extends AbstractDSLTest
{
    ...
    public function testMatch()
    {
        ...
        $this->assertInstanceOf(Match1::class, $match);
    }
    ...
    public function testInterface()
    {
        ...
        $this->_assertImplemented($queryDSL, 'has_child', Query\HasChild::class, [new Match1()]);
        $this->_assertImplemented($queryDSL, 'has_parent', Query\HasParent::class, [new Match1(), 'type']);
        $this->_assertImplemented($queryDSL, 'ids', Query\Ids::class, [[]]);
        $this->_assertImplemented($queryDSL, 'match', Match1::class, ['field', 'values']);
